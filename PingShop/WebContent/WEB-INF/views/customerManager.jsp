													...
													<tr>
														<td>
															<div class="list-info mrg-top-10">
																<div class="info">
																	<span class="title">ID: ${cus.customerId}</span> <span
																		class="sub-title">${cus.customerName}</span>
																</div>
															</div>
														</td>
														<td>
															<div class="relative mrg-top-15">${cus.username}</div>
														</td>
														<td>
															<div class="relative mrg-top-15">${cus.password}</div>
														</td>
														<td>
															<div class="relative mrg-top-15">${cus.birthday}</div>
														</td>
														<td>
															<div class="relative mrg-top-15">${cus.sex}</div>
														</td>
														<td>
															<div class="relative mrg-top-15">${cus.email}</div>
														</td>
														<td>
															<div class="relative mrg-top-15">${cus.address}</div>
														</td>
														<td>
															<div class="relative mrg-top-15">${cus.phone}</div>
														</td>
														<td>

			...
			<div class="side-nav">
				<div class="side-nav-inner">
					...
					<ul class="side-nav-menu scrollable">
						...
						<li class="nav-item dropdown"><a href="accountManager.poly">
								<span class="icon-holder"> <i class="ei-myspace"></i>
							</span> <span class="title">Quản lý khách hàng</span>
						</a></li>
						<li class="nav-item dropdown"><a href="categoryManager.poly">
								<span class="icon-holder"> <i class="ei-collaboration"></i>
							</span> <span class="title">Quản lý danh mục</span>
						</a></li>
						<li class="nav-item dropdown"><a href="productManager.poly">
								<span class="icon-holder"> <i class="ei-package-open"></i>

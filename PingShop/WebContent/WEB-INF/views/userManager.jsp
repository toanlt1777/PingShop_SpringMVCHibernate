			...
			<div class="side-nav">
				<div class="side-nav-inner">
					...
					<ul class="side-nav-menu scrollable">
						<li class="nav-item dropdown open"><a class="mrg-top-30"
							href="userManager.poly"> <span class="icon-holder"> <i
									class="ti-layout-media-overlay"></i>
			...
			<div class="page-container">
				...
				<div class="header navbar">
					<div class="header-container">
						...
						<ul class="nav-right">
							<li class="user-profile dropdown"><a href="data-table.html"
								class="dropdown-toggle" data-toggle="dropdown"> <img
									class="profile-img img-fluid"
									src="<c:url value="/resources/"/>assets/images/user.jpg"">
									<div class="user-info">
										<span class="name pdd-right-5">Administrator </span> <i
											class="ti-angle-down font-size-10"></i>
									</div>
							</a>
												...
												<div class="modal-dialog" role="document">
													<div class="modal-content">
														...
														<div class="modal-body">
															<form:form action="userManager.poly"
																modelAttribute="user"
																...
																<div class="form-group row">
																	<label for="form-1-3" class="col-md-2 control-label">Full
																		Name</label>
																	<div class="col-md-10">
																		<form:textarea path="fullname" name="fullname"
											...
											<table id="dt-opt" class="table table-lg table-hover">
												<thead>
													<tr>
														...
														<th>Password</th>
														<th>Full name</th>
														<th><i class="ti-settings pdd-right-10"></th>
													</tr>
												</thead>
												<tbody>
														...
														<tr>
															<td>
																<div class="list-info mrg-top-10">
																	<img class="thumb-img"
																		src="<c:url value="/resources/"/>assets/images/avatars/thumb-7.jpg"
																		" alt="">
																	<div class="info">
																		<span class="title">${u.username}</span> <span
																			class="sub-title">ID %</span>
																	</div>
																</div>
															</td>
															<td>
																<div class="relative mrg-top-15">${u.password}</div>
															</td>
															<td>
															...
															<td>
																...
																<div class="mrg-top-10 text-center">
																	...
																	<a href="userManager.poly?lnkEdit&username=${u.username}"
																		...
																		Sửa</a>
																	<button type="button"
																		class="btn btn-warning btn-rounded swal-pass-param"
																		onclick="window.location.href='<c:url value='?lnkDelete&username=${u.username}' />'">
